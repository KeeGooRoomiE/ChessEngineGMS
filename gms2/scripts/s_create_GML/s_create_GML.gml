		...
		for (j=0; j<8; j++) // cell rows
		{
			...
			switch (BoardPiece.ID)
		    {
		         ...
		         case 48:   BoardPiece.Piece_ID=0;
		                    BoardPiece.Color="White";        //Create pawns
