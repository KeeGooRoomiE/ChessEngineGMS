...
///Init board pieces and vars
  ...
  ///  global.Turn="White";//Sets the colour that starts first.
    ...
    for (P=0; P<=63; P++)
    {
        BoardPiece = instance_create_layer(X,Y,"Pieces",o_cell);  //Create a board cell
